...
for Input_Tin in Input_Dude_Tin_List:
    ...
    Polyline_Feature_Class = arcpy.CreateFeatureclass_management("in_memory", "out_name", geometry_type, template, has_m,
                                                            has_z)
    ...
    Polygon_Feature_Class = arcpy.CreateFeatureclass_management(out_path, out_name, geometry_type, template, has_m,
                                                            has_z)
