...
import org.n52.v3d.triturus.examples.gridding.TIN2Grid;
...
/**
 * Method not needed anymore, any odd number works
 */
...
//	}
    ...
    public VgElevationGrid transform(
    	GmSimpleTINFeature tin1, GmSimpleTINFeature tin2, short windowSize, int cellSize, String zConflictHandler, String windowForm)
    	throws T3dException
    {
    ...
    //    this.checkWindowSize(n);
		try {
			...
			VgEquidistGrid grdGeom = app.setUpGeometry(bbox, cellSize);
