	...
	{ 
		try {
	        ...
	        if (generateCrossSection) {
	        	...
	        	defLine.addVertex(new GmPoint(bbox.getXMin(), bbox.getYMin(), 0.));
	        	defLine.addVertex(new GmPoint(bbox.getXMax(), bbox.getYMax(), 0.));
	        	// TODO Zwischenpunkte generieren, z. B. alle 1000 m
	        	VgProfile 
        			sec1 = new FltElevationGrid2Profile().transform(grid1, defLine),
	        		sec2 = new FltElevationGrid2Profile().transform(grid2, defLine);
        		// TODO: Filter sollte > 1 Input verarbeiten können!
