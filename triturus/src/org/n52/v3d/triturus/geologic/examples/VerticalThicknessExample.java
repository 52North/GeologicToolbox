...
import org.n52.v3d.triturus.gisimplm.IoProfileWriter.SVGParameters;
 ...
 * <tt>wedgeMode</tt> to false.) Additionally, two cross-sections (so-called 
 * Triturus "profiles") will be generated and exported to SVG files. (Hint:
 * To get both profiles into a single diagramm, just add the &lt;path&gt; 
 * element given at the end of the second SVG file at the end of the first 
 * SVG file.)
 * 
